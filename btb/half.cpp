...
void O3_CPU::initialize_btb() {
  ...
  btb_partition[0].init_btb(256, 1);
  btb_partition[1].init_btb(256, 1);
  btb_partition[2].init_btb(256, 1);
  btb_partition[3].init_btb(256, 1);
  btb_partition[4].init_btb(256, 1);
  btb_partition[5].init_btb(256, 1);
  btb_partition[6].init_btb(256, 1);
  btb_partition[7].init_btb(256, 1);
