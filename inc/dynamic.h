...
public:
  ...
  ~O3_CPU() {
    ...
    cout << "stored in adjacent indexes" << endl;
    cout << changes[0] << "," << changes[1] << "," << changes[2] << endl;
    cout << "hit in adjacent indexes" << endl;
    cout << phit[0] << "," << phit[1] << "," << phit[2] << endl;
    cout << "update in adjacent indexes" << endl;
    cout << uhit[0] << "," << uhit[1] << "," << uhit[2] << endl;
